...
public class StatementsTest extends BaseTestCase {
    ...
    /**
     * Helper method for *SetObject* tests.
     * com.electricalweb.controllers.Check unsupported types behavior for the given PreparedStatement with a single placeholder. If this is a CallableStatement then the placeholder must
