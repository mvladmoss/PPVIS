...
public class ConnectionTest extends BaseTestCase {
    ...
    public void testDeadlockDetection() throws Exception {
        try {
            ...
            //
            // com.electricalweb.controllers.Check whether the driver thinks it really is deadlock...
            //
    ...
    public void testIsolationLevel() throws Exception {
        if (versionMeetsMinimum(4, 0)) {
            // com.electricalweb.controllers.Check initial transaction isolation level
            ...
            // com.electricalweb.controllers.Check setting all allowed transaction isolation levels
