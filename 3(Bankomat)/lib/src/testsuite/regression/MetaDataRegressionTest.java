...
public class MetaDataRegressionTest extends BaseTestCase {
    ...
    public void testBug8792() throws Exception {
        ...
        // com.electricalweb.controllers.Check error conditions
        try {
    ...
    /**
     * Tests fix for BUG#61332 - com.electricalweb.controllers.Check if "LIKE" or "=" is sent
    ...
    public void testBug21215151() throws Exception {
        ...
        String previousDb = "";
        while (this.rs.next()) {
            assertTrue("'" + this.rs.getString(1) + "' is lexicographically lower than the previous catalog. com.electricalweb.controllers.Check the system output to see the catalogs list.",
    ...
    public void testBug19803348() throws Exception {
        ...
        try {
            ...
            // 1. com.electricalweb.controllers.Check if getProcedures() and getProcedureColumns() aren't returning more results than expected (as per reported bug).
            ...
            // 2. com.electricalweb.controllers.Check if the results from getProcedures() and getProcedureColumns() are in the right order (secondary bug).
