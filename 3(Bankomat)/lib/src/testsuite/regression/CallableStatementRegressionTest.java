...
public class CallableStatementRegressionTest extends BaseTestCase {
    ...
    public void testBug10310() throws Exception {
        ...
        try {
            ...
            // com.electricalweb.controllers.Check metadata while we're at it
            ...
            // com.electricalweb.controllers.Check with literals, not all parameters filled!
    ...
    public void testBug79561() throws Exception {
        ...
        for (int i = 0; i < sql.length; i++) {
            for (int m = 0; m < 4; m++) { // Method call type: 0) by index; 1) by name; 2) by invalid index; 3) by invalid name;
                ...
                // com.electricalweb.controllers.Check the returned data, if any expected, using different methods.
                if (dataExpected) {
                    cstmt.execute();
