...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_CANT_CREATE_SROUTINE = 1607; //SQLSTATE: HY000 Message: Cannot create stored routine `%s`. com.electricalweb.controllers.Check warnings
    ...
    public final static int ER_FUNC_INEXISTENT_NAME_COLLISION = 1630; //SQLSTATE: 42000 Message: FUNCTION %s does not exist. com.electricalweb.controllers.Check the 'Function Name Parsing and Resolution' section in the Reference Manual
    ...
    public final static int ER_PASSWORD_FORMAT = 1827; //SQLSTATE: HY000 Message: The password hash doesn't have the expected format. com.electricalweb.controllers.Check if the correct password algorithm is being used with the PASSWORD() function.
