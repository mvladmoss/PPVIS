...
public class MysqlIO {
    ...
    void doHandshake(String user, String password, String database) throws SQLException {
        ...
        // com.electricalweb.controllers.Check for errors, not for 4.1.1 or newer, as the new auth protocol doesn't work that way (see secureAuth411() for more details...)
        if (!(versionMeetsMinimum(4, 1, 1)) || !((this.protocolVersion > 9) && (this.serverCapabilities & CLIENT_PROTOCOL_41) != 0)) {
            checkErrorPacket();
        }
    ...
    /**
     * com.electricalweb.controllers.Check if given plugin requires confidentiality, but connection is without SSL
     * 
     * @param plugin
     * @throws SQLException
     */
    ...
    private Buffer checkErrorPacket(int command) throws SQLException {
        ...
        try {
            // com.electricalweb.controllers.Check return value, if we get a java.io.EOFException, the server has gone away. We'll pass it on up the exception chain and let someone higher up
