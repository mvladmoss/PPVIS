...
public class StringUtils {
    ...
    public static int getInt(byte[] buf, int offset, int endPos) throws NumberFormatException {
        ...
        /* com.electricalweb.controllers.Check for a sign. */
        ...
        for (; s < endPos; s++) {
            ...
            /* com.electricalweb.controllers.Check for overflow. */
    ...
    public static String quoteIdentifier(String identifier, String quoteChar, boolean isPedantic) {
        ...
        // com.electricalweb.controllers.Check if the identifier is correctly quoted and if quotes within are correctly escaped. If not, quote and escape it.
        if (!isPedantic && identifier.startsWith(quoteChar) && identifier.endsWith(quoteChar)) {
            ...
            // com.electricalweb.controllers.Check for pairs of quotes.
    ...
    public static String unQuoteIdentifier(String identifier, String quoteChar) {
        ...
        // com.electricalweb.controllers.Check if the identifier is really quoted or if it simply contains quote chars in it (assuming that the value is a valid identifier).
