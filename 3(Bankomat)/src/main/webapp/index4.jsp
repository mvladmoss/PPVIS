...
%>
<div class="success">
    <h3>К сожалению, у вас недостаточно средств для этой операции</h3>
    <a class="btn btn-primary" href="index3.jsp"   role="button">Вернуться</a>
</div>
<!-- Optional JavaScript -->
